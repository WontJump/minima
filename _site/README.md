This is a fork of the minima theme (standard jekyll theme) for the Oxford SIAM-IMA student chapter. If you want files you can serve go to the _site folder. This should work (hopefully)
